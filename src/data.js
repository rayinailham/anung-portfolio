...
export const experience = [
  ...
  },
  {
    ...
    evidence: {
      ...
      items: [
        {
          id: 'konten-sosial', type: '4+ konten Instagram & TikTok',
          src: '/images/konten-sosial.webp', width: 1200, height: 900,
          alt: 'Kompilasi empat materi konten media sosial Anima Companion dan Sutan Vet Medika: materi edukasi perawatan luka, suplemen Felcover+, serta konten meme kucing.',
          caption: 'Cuplikan konten Instagram dan TikTok yang saya buat untuk Anima Companion, mencakup konten edukasi kesehatan anabul, pengenalan suplemen, serta konten meme organik.',
        },
        {
          id: 'video-produk', type: '3 video produk + video profil perusahaan',
          src: '/images/video-produk.webp', width: 1200, height: 900,
          alt: 'Cuplikan video promosi produk Felcover+ menampilkan drh. Baradillah Abdyad dari Ciba Vet dan dokter hewan mitra menjelaskan manfaat suplemen klinis.',
          caption: 'Tangkapan layar video promosi produk Felcover+ (PT Sutan Vet Medika) yang menyajikan rekomendasi serta tinjauan klinis dari para dokter hewan klinik mitra.',
        },
        {
          id: 'webinar-b2b', type: 'Webinar B2B 15+ peserta',
          src: '/images/webinar-b2b.webp', width: 1200, height: 900,
          alt: 'Tangkapan layar Zoom Workplace sesi Webinar B2B PT Sutan Vet Medika dihadiri 23 peserta, termasuk dokter hewan dan klinik hewan mitra.',
          caption: 'Dokumentasi sesi Webinar B2B PT Sutan Vet Medika via Zoom Workplace bersama 23 peserta, mencakup dokter hewan dan perwakilan klinik hewan mitra di berbagai daerah.',
        },
      ],
    },
  },
