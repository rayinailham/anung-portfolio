...
Photographs and CV previews are produced by `node scripts/prepare-assets.mjs`. Generated placeholder covers follow their tickets; the OG share card uses the reproducible composition script documented below.
